...
export const LegalAndRulesModal: React.FC<LegalAndRulesModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-900/60 dark:bg-black/80 backdrop-blur-md overflow-y-auto animate-in fade-in duration-200"
      onClick={onClose}
    >
      <div
        className="glass w-full max-w-4xl max-h-[92vh] flex flex-col rounded-2xl border border-slate-200 dark:border-white/[0.12] bg-white/95 dark:bg-[#0A0D14]/95 text-slate-800 dark:text-slate-100 shadow-2xl overflow-hidden my-auto"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Modal Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-white/[0.09] bg-slate-50/80 dark:bg-white/[0.02]">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 rounded-lg bg-yellow-400/20 border border-yellow-400/40 flex items-center justify-center text-yellow-700 dark:text-[#FACC15]">
        ...
        {/* Tab Selector */}
        <div className="flex border-b border-slate-200 dark:border-white/[0.08] px-6 bg-slate-100/70 dark:bg-black/30 overflow-x-auto scrollbar-none">
          <button
            type="button"
            ...
            className={`flex items-center space-x-2 py-3 px-4 border-b-2 font-bold text-xs uppercase tracking-wider transition-colors whitespace-nowrap cursor-pointer ${
              activeTab === 'rules'
                ? 'border-yellow-500 dark:border-[#FACC15] text-yellow-800 dark:text-[#FACC15] bg-yellow-400/10'
        ...
        {/* Content Body */}
        <div className="flex-1 overflow-y-auto p-6 sm:p-8 space-y-6 text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
          {/* TAB 1: RULES & REGULATIONS */}
          {activeTab === 'rules' && (
            <div className="space-y-6">
              <div className="p-4 rounded-xl bg-yellow-50 dark:bg-yellow-400/10 border border-yellow-300 dark:border-yellow-400/25 text-yellow-900 dark:text-yellow-200 text-xs">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-1.5">
                  <div className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-sm">
                    <span className="text-yellow-700 dark:text-[#FACC15] font-mono">Rule 1:</span>
                    <span>Total Weight Declaration &amp; Weigh/Inspection (W&amp;I) Audits</span>
                  </div>
                  <p className="text-slate-600 dark:text-slate-400 text-xs">
                    The weight entered during quotation must represent the <strong>TOTAL combined gross shipment weight</strong> of all line items, including packaging, skids, crates, and pallets. The system does not multiply units by weight. Certified carrier terminal scales systematically re-weigh shipments; discrepancies will be adjusted based on certified scale tickets.
                  </p>
                </div>

                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-1.5">
                  <div className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-sm">
                    <span className="text-yellow-700 dark:text-[#FACC15] font-mono">Rule 2:</span>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-1.5">
                  <div className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-sm">
                    <span className="text-yellow-700 dark:text-[#FACC15] font-mono">Rule 3:</span>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-1.5">
                  <div className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-sm">
                    <span className="text-yellow-700 dark:text-[#FACC15] font-mono">Rule 4:</span>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-1.5">
                  <div className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-sm">
                    <span className="text-yellow-700 dark:text-[#FACC15] font-mono">Rule 5:</span>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-1.5">
                  <div className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-sm">
                    <span className="text-yellow-700 dark:text-[#FACC15] font-mono">Rule 6:</span>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-1.5">
                  <div className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-sm">
                    <span className="text-yellow-700 dark:text-[#FACC15] font-mono">Rule 7:</span>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-1.5">
                  <div className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-sm">
                    <span className="text-yellow-700 dark:text-[#FACC15] font-mono">Rule 8:</span>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-1.5">
                  <div className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-sm">
                    <span className="text-yellow-700 dark:text-[#FACC15] font-mono">Rule 9:</span>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-1.5">
                  <div className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-sm">
                    <span className="text-yellow-700 dark:text-[#FACC15] font-mono">Rule 10:</span>
          ...
          {activeTab === 'privacy' && (
            <div className="space-y-6">
              <div className="p-4 rounded-xl bg-sky-50 dark:bg-sky-500/10 border border-sky-300 dark:border-sky-500/25 text-sky-900 dark:text-sky-200 text-xs">
              ...
              <div className="space-y-5">
                <div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1.5">1. Information We Collect</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs">
                    To deliver accurate freight rate calculations and execute transport bookings, we collect:
                  </p>
                  <ul className="list-disc pl-5 mt-1.5 space-y-1 text-slate-600 dark:text-slate-400 text-xs">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1.5">2. How Your Information Is Used</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1.5">3. Transmission to Certified Carriers</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1.5">4. Security &amp; Encryption Standards</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1.5">5. Data Retention &amp; Compliance Officer Contact</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs">
                  ...
                  <div className="mt-2 p-3 rounded-lg bg-slate-100 dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.08] text-xs font-mono text-slate-700 dark:text-slate-300">
                    <div><strong>Jason LTL &bull; CYL Ltd. Transportation Compliance</strong></div>
                    <div>Email: <a href="mailto:Jason@cylltd.com" className="text-sky-700 dark:text-[#38BDF8] underline">Jason@cylltd.com</a></div>
          ...
          {activeTab === 'terms' && (
            <div className="space-y-6">
              <div className="p-4 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-300 dark:border-emerald-500/25 text-emerald-900 dark:text-emerald-200 text-xs">
              ...
              <div className="space-y-5">
                <div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1.5">1. Quotation Tariff Validity &amp; 120-Second Engine Scans</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1.5">2. Billing, Credit &amp; Invoicing</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1.5">3. Freight Claims &amp; Inspection Procedures</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1.5">4. Governing Law &amp; Carmack Amendment</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs">
        ...
        {/* Modal Footer */}
        <div className="flex items-center justify-between px-6 py-4 border-t border-slate-200 dark:border-white/[0.09] bg-slate-50/80 dark:bg-white/[0.02]">
